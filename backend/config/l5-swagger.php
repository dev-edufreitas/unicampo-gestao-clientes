...
return [
    ...
    'defaults' => [
        ...
        'paths' => [
             ...
             * @deprecated Please use `exclude_paths` instead.
             */
            'excludes' => [],
        ],
        ...
        'scanOptions' => [
            ...
            /*
             * Absolute path to directories that should be exclude from scanning
             * @note This option overwrites `excludes`
             */
            'exclude' => [],
        ],
         ...
         * 'method' (sort by HTTP method) or a function (see the readme for details)
         */
        ...
        'ui' => [
            'display' => [
                 ...
                 * the tag.
                 */
                'filter' => env('L5_SWAGGER_UI_FILTERS', true), // true | false | string
            ],
